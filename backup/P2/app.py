...
from sqlfunc import course_tasks_graph, task_result_graph, subm_time_graph
...
def cours1_G1():
    ...
    return render_template('cours/cours1/cours1_G1.html', label=l[2], cours=l[1], val=l[3], type=l[0], bordercolor=l[4], background=l[5])


@app.route('/cours1_G2.html')
def cours1_G2():
    l = task_result_graph("LSINF1252", "simple_stack")
    return render_template('cours/cours1/cours1_G1.html', label=l[3], cours=l[1], val=l[4], type=l[2], bordercolor=l[5], background=l[6])


@app.route('/cours1_G3.html')
def cours1_G3():
    l = subm_time_graph("LSINF1252", "2020-01-15T00:00", "2020-3-22T00:00")
    return render_template('cours/cours1/cours1_G1.html', label=l[2], cours=l[1], val=l[3], type=l[0], bordercolor=l[4],
                           background=l[5])
...
def cours2_G2():
    l = task_result_graph("LEPL1402", "HanoiTower")
    return render_template('cours/cours1/cours1_G1.html', label=l[3], cours=l[1], val=l[4], type=l[2], bordercolor=l[5], background=l[6])
...
def cours3_G2():
    l = task_result_graph("LSINF1101-PYTHON", "Quetelet")
    return render_template('cours/cours1/cours1_G1.html', label=l[3], cours=l[1], val=l[4], type=l[2], bordercolor=l[5], background=l[6])
